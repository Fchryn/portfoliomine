...
<div class="sidebar z-10 shadow-md bg-teal-950" id="mySidebar">
    ...
    <nav class=" mt-10">
      <a href="/admin" class="flex py-3 px-6 active:text-black hover:text-slate-300 hover:bg-slate-950 items-center">
      ...
      <a href="/admin/about" class="flex py-3 px-6 active:text-black hover:text-slate-300 hover:bg-slate-950 items-center">
      ...
      <a href="/admin/contact" class="flex py-3 px-6 active:text-black hover:text-slate-300 hover:bg-slate-950 items-center">
